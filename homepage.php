<?php
session_start();
//Home page checks the id if id = 1 shows the admin homepage or just the user one
 ?>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <ul class="navbar-nav">
              ...
              echo"<h1 style='color:white;position:sticky;'>WELCOME </h1><b style = 'color: white;font-size: 40px'><i> ".ucwords($rel['name'])." !</i></b>
                  </div>
                  </header>
                  <section>
